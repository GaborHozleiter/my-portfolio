...
export class TranslateService {
  ...
  aboutMeTextCenterGerman : string = 'Ich habe umfassende Kenntnisse in der Frontend-Entwicklung und bin offen für neue Technologien. Dank meiner schnellen Einarbeitung in neue Tools und Trends kann ich innovative Lösungen entwickeln.';
  aboutMeTextBottomGerman : string = 'Durch die Developer Akademie habe ich meine Frontend-Fähigkeiten ausgebaut und bin kompetent in der Software-Entwicklung. Ich freue mich darauf, mein Wissen in einem neuen Job anzuwenden und zu vertiefen.';
